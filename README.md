...
[![Tested with Pytest](https://img.shields.io/github/actions/workflow/status/Alishahryar1/free-claude-code/tests.yml?style=for-the-badge&label=Tested%20with%20Pytest)](https://github.com/Alishahryar1/free-claude-code/actions/workflows/tests.yml)
